...
def graph_config(args, parser):
    ...
    if all_args.auto_mini_batch_size:
        ...
        print("all_args.n_rollout_threads:", all_args.n_rollout_threads)
        print("all_args.episode_length:", all_args.episode_length)
        print("all_args.num_agents:", all_args.num_agents)
        print("all_args.target_mini_batch_size:", all_args.target_mini_batch_size)
