...
from baselines.onpolicy.utils.separated_buffer import SeparatedReplayBuffer
...
class Runner(object):
    def __init__(self, config):
        ...
        for agent_id in range(self.num_agents):
            ...
            share_observation_space = obs_shape_n[agent_id]
            # policy network
            po = Policy(self.all_args,
                        obs_shape_n[agent_id],
                        share_observation_space,
                        action_shape_n[agent_id],
                        device = self.device)
