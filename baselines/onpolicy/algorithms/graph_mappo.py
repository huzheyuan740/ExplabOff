...
class GR_MAPPO():
    ...
    def __init__(self, 
        ...
        print("0000000self.num_mini_batch", self.num_mini_batch)
        print("0000000self.data_chunk_length", self.data_chunk_length)
    ...
    def cal_value_loss(self, 
        ...
        if self._use_popart or self._use_valuenorm:
            self.value_normalizer.update(return_batch)  # TODO 问题所在!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def train(self, 
        ...
        for _ in range(self.ppo_epoch):
            ...
            # print("data_generator:", data_generator.size())  # TODO 之后得细究一下
