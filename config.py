...
class TrainConfig:
    def __init__(self):
        ...
        self.load_buffer_name = 'bad'


class BaseStationSetConfig:
    def __init__(self):
        self.base_station_num = 2
        self.mobile_device_num = 3
...
class BaseStationConfig:
    def __init__(self):
        ...
        self.base_station_computing_ability_eval_list = [8.6]
...
class TaskConfig:
    def __init__(self):
        ...
        self.task_data_size_now = [6 + 1, 5 + 1, 2 + 1]
        ...
        self.task_tolerance_delay_list = [1.808, 1.806, 1.805]
